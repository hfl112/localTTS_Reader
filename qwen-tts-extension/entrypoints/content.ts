export default defineContentScript({
  matches: ["<all_urls>"],
  main() {
    console.log("Qwen TTS Content Script Loaded: Initializing UI...");

    // Helper to call backend via background script (Bypasses CSP)
    ...
    function showToast(msg: string) {
      ...
      toast.style.cssText = `
        ...
        z-index: 2147483647; animation: fadeInUp 0.3s ease;
      `;
